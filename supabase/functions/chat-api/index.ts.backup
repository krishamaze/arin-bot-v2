...
// =============================================================================
function buildPromptMessages(botUsername, botPlatformId, botPersonality, roomSummary, userRoomSummaries, userAndBotRoomSummaries, userAndBotGlobalSummaries, recentEventsNarrative) {
...
console.log('🤖 Cached Natural Conversation Bot v8.0 - Optimized with Prompt Caching');